...
<aside class="sidebar" id="sidebar">
    <a href="{{ route('company.dashboard') }}" class="sidebar-brand">
        <span class="sidebar-brand-icon"><i class="fas fa-building"></i></span>
        <span class="sidebar-brand-text">
            إدارة المتجر
            <small>{{ auth()->user()->company?->company_name ?? 'شركتي' }}</small>
        </span>
    </a>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('company.dashboard') }}"
           class="nav-item {{ request()->routeIs('company.dashboard') ? 'active' : '' }}">
            <span class="nav-icon"><i class="fas fa-gauge-high"></i></span>
            <span class="nav-label">لوحة التحكم</span>
        </a>

        <div class="nav-section-label">العمليات</div>

        <a href="{{ route('company.products.index') }}"
           class="nav-item {{ request()->routeIs('company.products.*') ? 'active' : '' }}">
            <span class="nav-icon"><i class="fas fa-box-open"></i></span>
            <span class="nav-label">المنتجات</span>
        </a>

        <a href="{{ route('company.orders.index') }}"
           class="nav-item {{ request()->routeIs('company.orders.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('company.customers.index') }}"
           class="nav-item {{ request()->routeIs('company.customers.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('company.reports.sales') }}"
           class="nav-item {{ request()->routeIs('company.reports.sales') ? 'active' : '' }}">
            <span class="nav-icon"><i class="fas fa-chart-line"></i></span>
            <span class="nav-label">المبيعات</span>
        </a>

        <a href="{{ route('company.reports.products') }}"
           class="nav-item {{ request()->routeIs('company.reports.products') ? 'active' : '' }}">
            <span class="nav-icon"><i class="fas fa-chart-bar"></i></span>
            <span class="nav-label">أداء المنتجات</span>
        </a>

        <div class="nav-section-label">الإعدادات والتخصيص</div>

        <a href="{{ route('company.profile.edit') }}"
           class="nav-item {{ request()->routeIs('company.profile.*') ? 'active' : '' }}">
            <span class="nav-icon"><i class="fas fa-building-user"></i></span>
            <span class="nav-label">ملف الشركة</span>
        </a>
        ...
        <a href="{{ route('company.settings.edit') }}"
           class="nav-item {{ request()->routeIs('company.settings.*') ? 'active' : '' }}">
            ...
            <span class="nav-label">تخصيص المتجر</span>
        </a>
    </nav>
    ...
    <div class="sidebar-footer">
        ...
        <div class="sidebar-user" onclick="document.getElementById('logoutForm').submit()" style="cursor:pointer" title="تسجيل الخروج">
            ...
            <div class="sidebar-user-info">
                ...
                <div class="sidebar-user-role">مدير شركة</div>
            </div>
        </div>
    </div>
</aside>
...
<header class="topbar" id="topbar">
    ...
    <nav class="topbar-breadcrumb">
        <a href="{{ route('company.dashboard') }}"><i class="fas fa-house"></i></a>
    ...
    <div class="topbar-actions">
        ...
        <a href="{{ auth()->user()->company ? route('front.home', ['slug' => auth()->user()->company->slug ?? '']) : '#' }}" target="_blank" class="topbar-btn" style="color:var(--primary)" title="عرض متجري">
        ...
        <div class="topbar-user" id="topbarUser">
            ...
            <div>
                ...
                <div class="topbar-user-role">مدير شركة</div>
            </div>
            <i class="fas fa-chevron-down" style="font-size:0.7rem; color: var(--text-3); margin-right: 4px;"></i>

            <div class="topbar-user-dropdown">
                <a href="{{ route('company.profile.edit') }}" class="dropdown-item">
                    <i class="fas fa-building"></i> ملف الشركة
                </a>
                <a href="{{ route('company.settings.edit') }}" class="dropdown-item">
                    <i class="fas fa-palette"></i> تخصيص المتجر
                </a>
